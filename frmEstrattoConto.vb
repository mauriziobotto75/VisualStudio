...
#Region "Codice generato dalla finestra di progettazione Windows Form "
	...
	Private ADOBind_qryNumConto As VB6.MBindingCollection
	...
	Public WithEvents lstMovimenti As System.Windows.Forms.ListBox
	Public WithEvents cmdVisualizzaSituazione As System.Windows.Forms.Button
	Public WithEvents dtcNumConto As AxMSDataListLib.AxDataCombo
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEstrattoConto))
		...
		Me.lstMovimenti = New System.Windows.Forms.ListBox
		Me.cmdVisualizzaSituazione = New System.Windows.Forms.Button
		Me.dtcNumConto = New AxMSDataListLib.AxDataCombo
		...
		CType(Me.dtcNumConto, System.ComponentModel.ISupportInitialize).BeginInit()
		...
		Me.Text = "Visualizzazione Estratto Conto"
		...
		Me._imgTestata_10.Location = New System.Drawing.Point(624, 16)
		...
		Me.Label11.Location = New System.Drawing.Point(624, 56)
		...
		Me._imgTestata_6.Location = New System.Drawing.Point(504, 16)
		...
		Me.Label8.Text = "F12 - Torna al menù principale"
		Me.Label8.Size = New System.Drawing.Size(81, 25)
		Me.Label8.Location = New System.Drawing.Point(688, 56)
		...
		Me.Label7.Text = "F8 - Titoli"
		Me.Label7.Size = New System.Drawing.Size(81, 17)
		Me.Label7.Location = New System.Drawing.Point(568, 56)
		...
		Me._imgTestata_7.Location = New System.Drawing.Point(568, 16)
		...
		Me.lstMovimenti.Size = New System.Drawing.Size(585, 202)
		Me.lstMovimenti.Location = New System.Drawing.Point(168, 216)
		Me.lstMovimenti.TabIndex = 3
		Me.lstMovimenti.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
		Me.lstMovimenti.BackColor = System.Drawing.SystemColors.Window
		Me.lstMovimenti.CausesValidation = True
		Me.lstMovimenti.Enabled = True
		Me.lstMovimenti.ForeColor = System.Drawing.SystemColors.WindowText
		Me.lstMovimenti.IntegralHeight = True
		Me.lstMovimenti.Cursor = System.Windows.Forms.Cursors.Default
		Me.lstMovimenti.SelectionMode = System.Windows.Forms.SelectionMode.One
		Me.lstMovimenti.RightToLeft = System.Windows.Forms.RightToLeft.No
		Me.lstMovimenti.Sorted = False
		Me.lstMovimenti.TabStop = True
		Me.lstMovimenti.Visible = True
		Me.lstMovimenti.MultiColumn = False
		Me.lstMovimenti.Name = "lstMovimenti"
		Me.cmdVisualizzaSituazione.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
		Me.cmdVisualizzaSituazione.Text = "Visualizza Situazione"
		Me.cmdVisualizzaSituazione.Size = New System.Drawing.Size(137, 49)
		Me.cmdVisualizzaSituazione.Location = New System.Drawing.Point(240, 464)
		Me.cmdVisualizzaSituazione.TabIndex = 2
		Me.cmdVisualizzaSituazione.BackColor = System.Drawing.SystemColors.Control
		Me.cmdVisualizzaSituazione.CausesValidation = True
		Me.cmdVisualizzaSituazione.Enabled = True
		Me.cmdVisualizzaSituazione.ForeColor = System.Drawing.SystemColors.ControlText
		Me.cmdVisualizzaSituazione.Cursor = System.Windows.Forms.Cursors.Default
		Me.cmdVisualizzaSituazione.RightToLeft = System.Windows.Forms.RightToLeft.No
		Me.cmdVisualizzaSituazione.TabStop = True
		Me.cmdVisualizzaSituazione.Name = "cmdVisualizzaSituazione"
		dtcNumConto.OcxState = CType(resources.GetObject("dtcNumConto.OcxState"), System.Windows.Forms.AxHost.State)
		Me.dtcNumConto.Size = New System.Drawing.Size(161, 21)
		Me.dtcNumConto.Location = New System.Drawing.Point(168, 136)
		Me.dtcNumConto.TabIndex = 0
		Me.dtcNumConto.Name = "dtcNumConto"
		...
		Me.Controls.Add(lstMovimenti)
		Me.Controls.Add(cmdVisualizzaSituazione)
		Me.Controls.Add(dtcNumConto)
		...
		CType(Me.dtcNumConto, System.ComponentModel.ISupportInitialize).EndInit()
		Me.mFile.Index = 0
		Me.mnuEsci.Index = 1
...
#Region "Supporto aggiornamento "
	Private Shared m_vb6FormDefInstance As frmEstrattoConto
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As frmEstrattoConto
		Get
			If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
				m_InitializingDefInstance = True
				m_vb6FormDefInstance = New frmEstrattoConto()
	...
	End Property
#End Region 
	Private Sub cmdVisualizzaSituazione_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdVisualizzaSituazione.Click
		Dim recSituzione As Object
		Dim giornoSettimana As String
		Dim data1 As Date
		Dim data2 As Date
		Dim giorniValuta As Date
		Dim dataInizio As Date
		Dim dataFine As Date
		Dim stringa As String
		Dim recSituazione As New ADODB.Recordset
		Dim recCopia As New ADODB.Recordset
		Dim sqlSituazione As String
		'dataInizio = CDate(dtcGG.Text & dtcMM.Text & dtcAnno.Text)
		'giornoSettimana = DaysOfWeek(dataInizio)
		'dataInizio = giornoSettimana & " " & dataInizio
		'dataFine = CDate(dtcGiorniF.Text & dtcMeseF.Text & dtcAnnoF.Text)
		'giornoSettimana = DayOfWeek(dataFine)
		'dataFine = giornoSettimana & " " & dataFine
		
		sqlSituazione = "Select * from movimenti where numConto = '" & dtcNumConto.CtlText & "' order by dataMovimento"
		
		'sqlSituazione = sqlSituazione & " and dataMovimento >= " & dataInizio & " and dataMovimento <= " & dataFine
		Dim numero As Short
		
		
		recSituzione = New ADODB.Recordset
		
		
		recSituazione.Open(sqlSituazione, deBanche.conBanche.ConnectionString, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
		If recSituazione.EOF = True Then
			MsgBox("Nessun movimento per questo conto!", MsgBoxStyle.OKOnly + MsgBoxStyle.Exclamation, "Errore")
			Exit Sub
		Else
			
			lstMovimenti.Items.Clear()
			recSituazione.MoveFirst()
			data1 = recSituazione.Fields!dataValuta.Value
			recCopia = New ADODB.Recordset
			
			recCopia.Open(sqlSituazione, deBanche.conBanche.ConnectionString, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
			...
			Do While recSituazione.EOF = False
				stringa = recSituazione.Fields!dataMovimento.Value & Space(10)
				stringa = stringa & recSituazione.Fields!desMovimento.Value & Space(10)
				stringa = stringa & recSituazione.Fields!importo.Value & Space(10)
				stringa = stringa & recSituazione.Fields!dataValuta.Value & Space(10)
				giorniValuta = System.Date.FromOADate(VB.Day(recCopia.Fields!dataValuta.Value) - VB.Day(recSituazione.Fields!dataValuta.Value))
				stringa = stringa & giorniValuta
				lstMovimenti.Items.Insert(numero, stringa)
				numero = numero + 1
				recSituazione.MoveNext()
				recCopia.MoveNext()
			Loop 
		End If
		
		recSituazione.Close()
		'UPGRADE_NOTE: È possibile che l'oggetto recSituazione non venga eliminato finché non venga raccolto nel Garbage Collector. Fare clic qui per ulteriori informazioni: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1029"'
		recSituazione = Nothing
	...
	Private Sub lstMovimenti_DoubleClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles lstMovimenti.DoubleClick
		lstMovimenti.Items.Clear()
	...
	Public Sub VB6_AddADODataBinding()
		deBanche.qryNumConto()
		ADOBind_qryNumConto = New VB6.MBindingCollection()
		ADOBind_qryNumConto.DataSource = deBanche
		ADOBind_qryNumConto.DataMember = "qryNumConto"
		ADOBind_qryNumConto.UpdateMode = VB6.UpdateMode.vbUpdateWhenPropertyChanges
		ADOBind_qryNumConto.UpdateControls()
	End Sub
	Public Sub VB6_RemoveADODataBinding()
		ADOBind_qryNumConto.Clear()
		ADOBind_qryNumConto.Dispose()
		ADOBind_qryNumConto = Nothing
	End Sub
End Class